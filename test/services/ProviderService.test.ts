...
describe('ProviderService Tests', () => {
  ...
  const setupService = () => {
    ...
    mockProviderRepository = {
      validateApiKey: (provider: string) => {
        ...
        return validKeys[provider] || { valid: false, message: 'Unknown provider' }
      },
    ...
    providerService = new DefaultProviderService(mockConfigService, mockProviderRepository)
  }
  ...
  describe('getAvailableProviders() method', () => {
    ...
    test('should return empty array when no valid API keys', () => {
      ...
      mockProviderRepository.validateApiKey = () => ({ valid: false, message: 'No API key' })
  ...
  describe('getProviderInfo() method', () => {
    test('should return provider information', () => {
      ...
      assert.ok(!anthropicInfo, 'Anthropic should not be included without valid API key')
    })
    ...
    test('should handle empty provider configs', () => {
      ...
      mockProviderRepository.validateApiKey = () => ({ valid: false, message: 'No config' })
  ...
  describe('validateProvider() method', () => {
    ...
    test('should handle null/undefined provider', () => {
      ...
      assert.strictEqual(providerService.validateProvider(undefined as any), false)
    })
  })
  ...
  describe('getProviderModel() method', () => {
    ...
    test('should handle different providers', () => {
      ...
      const anthropicModel = providerService.getProviderModel('anthropic', 'claude-3-5-haiku-20241022')
  ...
  describe('validateApiKey() method', () => {
    test('should validate API keys', () => {
      ...
      assert.strictEqual(anthropicResult.message, 'Anthropic API key not configured')
  ...
  describe('Integration with DI Container', () => {
    test('should be resolvable from DI container', async () => {
      ...
      const service = container.resolve<DefaultProviderService>('ProviderService')
